...
namespace satinalma.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("payment_id,order_id,payment_date,amount,payment_method,payment_status")] Payments payments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("payment_id,order_id,payment_date,amount,payment_method,payment_status")] Payments payments)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PaymentsExists(payments.payment_id))
                    {
                        return NotFound();
                    }
                    else
